...
const T: Record<Lang, Record<string, string>> = {
  FR: {
    ...
    analyticsSignalsDesc: '≥ 3 incidents — même catégorie & département — en 14 jours',
    analyticsSignalsCount: '{n} incidents',
    analyticsSignalsEmpty: 'Aucun signal de récurrence',
    analyticsSignalsEmptyDesc:
      "Aucun motif répétitif n'a été détecté sur la période.",
  ...
  AR: {
    ...
    analyticsSignalsDesc: '≥ 3 حوادث — نفس الفئة والقسم — خلال 14 يومًا',
    analyticsSignalsCount: '{n} حوادث',
    analyticsSignalsEmpty: 'لا توجد إشارات تكرار',
    analyticsSignalsEmptyDesc:
      'لم يتم اكتشاف أي نمط متكرر خلال الفترة.',
