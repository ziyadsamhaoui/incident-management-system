...
export function MobileBottomNav({ isVisible = true, onNavigate }: MobileBottomNavProps) {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 inset-x-0 z-40 bg-white border-t border-slate-200 flex items-center justify-around h-16 lg:hidden dark:bg-slate-900 dark:border-slate-800">
        {BOTTOM_TABS.map((tab) => {
          const Icon = tab.icon;
        ...
        {moreOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 inset-x-0 z-[70] bg-white border-t border-slate-200 rounded-t-2xl max-h-[70vh] overflow-y-auto lg:hidden dark:bg-slate-900 dark:border-slate-800"
            >
              {/* Handle */}
                    ...
                    return (
                      <div key={route.label}>
                        <button
                          ...
                          className="flex w-full items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-500 hover:text-slate-900 hover:bg-slate-100 transition-colors dark:text-slate-400 dark:hover:text-slate-100 dark:hover:bg-slate-800"
                        >
                        ...
                        <AnimatePresence>
                          {refDataExpanded && (
                            ...
                            >
                              <div className="ml-3 border-l border-slate-200 pl-3 space-y-0.5 py-1 dark:border-slate-700">
                                  ...
                                  <Link
                                    ...
                                    className={cn(
                                      ...
                                      pathname === child.href || pathname.startsWith(child.href + '/')
                                        ...
                                        : 'text-slate-500 hover:text-slate-900 hover:bg-slate-100 dark:hover:text-slate-200 dark:hover:bg-slate-800',
                                    )}
                                  >
